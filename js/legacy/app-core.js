...
// Public bridge for the ES Module shell. Templates continue to use the explicit
// global handlers registered above while the rest of the application migrates.
window.LOGCalendar = {
  get state() { return state; },
  saveState,
  persist,
  showToast,
  calendar: { render: renderCalendar, selectDay: renderSelectedDay },
  dayPanel: { render: renderSelectedDay },
  events: { open: openEventEntry, close: closeEventEntry },
  tasks: { render: renderChecklist, refresh: refreshChecklistAll },
  tracker: { render: renderRoutineTracker },
  stats: { render: renderStats },
  settings: { open: openSettings, close: closeSettings },
  theme: { toggle: toggleDarkMode },
  dock: {},
};
